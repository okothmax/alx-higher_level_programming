...
In this project, I learned how object-relational mapping is used for
database scripting. I started using MySQLdb and SQLAlchemy to
query, create, edit, and delete tables in MySQL db.

## Tests :heavy_check_mark:

* [tests](./tests): Folder for tests provided by ALX.
...
* **0. Get all states**
  ...
  * Usage: `./0-select_states.py <mysql username> <mysql password>
  <database name>`.
  * Results ordered by ascending `states.id`.
...
* **2. Filter states by user input**
  ...
  * Results ordered by ascending `states.id`.
  * Uses python string formatting to construct the SQL query.
...
* **4. Cities by states**
  ...
  * Usage: `./4-cities_by_state.py <mysql username> <mysql password>
  <database name>`.
  * Result ordered by ascending `cities.id`.
...
* **5. All cities by state**
  ...
  * Usage: `./5-filter_cities.py <mysql username> <mysql password>
  <database name>`.
  * Results sorted by ascending `cities.id`.
...
* **7. All states via SQLAlchemy**
  ...
  * Usage: `./7-model_state_fetch_all.py <mysql username> <mysql password>
  <database name>`.
  * Results sorted by ascending `states.id`.
